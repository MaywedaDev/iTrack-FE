...
const Nav = () => {
    return ( <div className="flex w-full px-8 py-5 border-b border-[#F7F7F7] bg-white">
        <div className="w-fit shrink-0 space-y-3">
            <h3 className="text-[18px] font-bold">Hello Sarah Mayowa!</h3>
        ...
        <div className="flex gap-x-4 items-center ml-auto">
            <img src={notifs} alt="" />
            <div className="rounded-full grid place-content-center bg-[#BDBDBD] text-white text-[18px] shrink-0 w-[44px] h-[44px]">OP</div>
            <div className="w-fit shrink-0">
                <h3 className="text-[18px] font-bold">Sarah Mayowa</h3>
